...
editor_tree = ET.parse('/Users/stevenbailey/UDI Development/Nodeservers/udi-poly-rheem-tankless-python-master/profile/editor/editors.xml')
...
nls = {}
with open('/Users/stevenbailey/UDI Development/Nodeservers/udi-poly-rheem-tankless-python-master/profile/nls/en_us.txt') as fp:
    for line in fp:
        line = line.rstrip()
        if line != "" and line[0] != '#':
            pair = line.split(" = ")
...
node_tree = ET.parse('/Users/stevenbailey/UDI Development/Nodeservers/udi-poly-rheem-tankless-python-master/profile/nodedef/nodedefs.xml')
